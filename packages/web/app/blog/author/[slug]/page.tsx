...
export async function generateMetadata({
  ...
  const author = await client.fetch<Author>(authorQuery, { slug });
...
export default async function AuthorPage({
  ...
  const [author, posts, totalPosts] = await Promise.all([
    client.fetch<Author>(authorQuery, { slug }),
    client.fetch<BlogPostPreview[]>(postsByAuthorQuery, {
      authorSlug: slug,
      start,
      end,
    }),
    client.fetch<number>(postsByAuthorCountQuery, { authorSlug: slug }),
  ]);
